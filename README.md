...
## 프로젝트 설명
**우리 프로젝트는 일주일 간의 기사를 크롤링 한 뒤, 카테고리별(정치, 경제, 사회)로 top keywords를 뽑아줍니다.
top keywords를 뽑기 위하여 LDA와 TextRank를 결합해 활용합니다. 
Django를 사용하여 각 날마다의 크롤링한 뉴스의 총 개수와 각 카테고리별 키워드의 뉴스 개수 차트를 시각화합니다.
